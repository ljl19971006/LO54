...
<div id="search">
    <div id="search-wrap">
        ...
        <input class="search-content" type="text" placeholder="entrer les mots cles" name="word" id="word">
...
<script >
    ...
    function search() {
        ...
        var URLa='http://localhost:8099/byword?word='+contexts;
        var URLb='http://localhost:8099/byDate?byDate='+contexts;
        // var URLc='http://localhost:8099/bydateandlocation?date='+date+'&location='+location;
        var vm=this;
        // $.ajax({
        //     type: 'get',
        //     // async:false,
        //     url: 'http://localhost:8099/byKeyWord?k=' + contexts,
        //     dataType: 'json',
        ...
        if (options == 'Key Word'){
            ...
            $.ajax({
                type:'get',
                // async:false,
                url: 'http://localhost:8099/date?date='+contexts,
                dataType: 'json',
                success: function(data){
                    window.open(URLb)
                },
           ...
           window.open("http://localhost:8099/dateandlocation")
        }
    }
